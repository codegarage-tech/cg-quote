...
public class TutorsActivity extends AppCompatActivity implements View.OnClickListener, TutorialListener {
    ...
    private void initViews() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                buttonHello.setAlpha((Float) animation.getAnimatedValue());
            }
        });
