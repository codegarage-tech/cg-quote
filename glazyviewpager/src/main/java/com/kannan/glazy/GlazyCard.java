...
public class GlazyCard implements Serializable {
    ...
    public GlazyCard withOccupation(String occupation) {
        mOccupation = occupation;
        return this;
    }

    public GlazyCard withNationality(String nationality) {
        mNationality = nationality;
        return this;
    }

    public GlazyCard withBirthDate(String birthDate) {
        mBirthDate = birthDate;
        return this;
    }

    public GlazyCard withDeathDate(String deathDate) {
