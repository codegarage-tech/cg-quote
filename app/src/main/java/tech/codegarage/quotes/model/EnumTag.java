...
public enum EnumTag {
    ...
    EXPRESS("Express"),
    PREPARED("Prepared"),
    THE_ONLY_THING("The Only Thing"),
    HONOR("Honor"),
    NUTS("Nuts"),
    CRACK("Crack"),
    CERTAIN_POINT("Certain Point"),
    ...
    TREATMENT("Treatment"),
    CARVING("Carving"),
    CERTAIN_THINGS("Certain Things"),
    PROVE("Prove"),
    HANDS("Hands"),
    SHAKE("Shake"),
    HUMAN_PROGRESS("Human Progress"),
    LONG_LIFE("Long Life"),
    DROP("Drop"),
    ...
    EQUAL("Equal"),
    MOTION("Motion"),
    HEAVENLY_BODIES("Heavenly Bodies"),
    ...
    SUFFER("Suffer"),
    HEARTS("Hearts"),
    MEASURE_OF_A_MAN("Measure Of A Man"),
    ENEMIES("Enemies"),
    ENOUGH("Enough"),
    NERVE("Nerve"),
    ENTAILS("Entails"),
