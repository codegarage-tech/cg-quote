...
import com.singhajit.sherlock.util.CrashUtils;
...
//    deviceAndroidVersion.setText(viewModel.getDeviceAndroidApiVersion());
        ...
        TextView tvDeviceInfo = (TextView) findViewById(R.id.tv_device_info);
        tvDeviceInfo.setText(CrashUtils.getDeviceDetails(CrashActivity.this));
    }
}
