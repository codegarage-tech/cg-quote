...
public class SharedUtil {
    ...
    private static final String SESSION_LITEPAL_CONFIG = "SESSION_LITEPAL_CONFIG";
    ...
    public static void setLitePalConfig(LitePalConfig litePalConfig) {
        String litePalString = LitePalConfig.convertFromObjectToString(litePalConfig);
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(LitePalApplication.getContext());
        SharedPreferences.Editor editor = sp.edit();
        editor.putString(SESSION_LITEPAL_CONFIG, litePalString);
        editor.commit();
    }

    public static LitePalConfig getLitePalConfig() {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(LitePalApplication.getContext());
        LitePalConfig litePalConfig = LitePalConfig.convertFromStringToObject(sp.getString(SESSION_LITEPAL_CONFIG, ""), LitePalConfig.class);
