 ...
 */
public final class Attribution implements Comparable<Attribution>, Parcelable {
    ...
    public static class Builder {
        ...
        public Builder addLicense(String name, String text, String textUrl) {
            licenseInfos.add(new LicenseInfo(name, text, textUrl));
            return this;
        }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeList(copyrightNotices);
    ...
    public Attribution(Parcel in) {
        ...
        this.copyrightNotices = in.readArrayList(String.class.getClassLoader());
        this.licensesInfo = in.readArrayList(LicenseInfo.class.getClassLoader());
